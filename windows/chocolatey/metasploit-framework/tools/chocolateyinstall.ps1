...
$url64       = 'https://downloads.metasploit.com/data/releases/metasploit-latest-windows-x64-installer.exe' 
$checksumRequest = invoke-webrequest 'https://downloads.metasploit.com/data/releases/metasploit-latest-windows-x64-installer.exe.sha1' -usebasicparsing
...
$packageArgs = @{
  ...
  softwareName  = 'metasploit-framework*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.                      
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  #checksum      = 'https://downloads.metasploit.com/data/releases/metasploit-latest-windows-x64-installer.exe.sha1'
  #checksumType  = 'sha1' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = $checksumRequest.ToString()
  checksumType64= 'sha1' #default is checksumType

  # MSI
  silentArgs    = "--unattendedmodeui none --mode unattended" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
  validExitCodes= @(0)
  # OTHERS
...
Add-MpPreference -ExclusionPath "C:\metasploit"
